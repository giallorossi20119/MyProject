...
void IAPPopup::requestIAPList()
{
    ...
    std::string strIAPListURL;
    if (GlobalVariable::m_iCurrentGame == 0)
    {
        GlobalVariable::m_sAppIDPurchase="1002";
        strIAPListURL = "http://bank.pinoygame.net/api/iapitems?aid=1002";
    }
    if (GlobalVariable::m_iCurrentGame == 1)
    {
        GlobalVariable::m_sAppIDPurchase="1003";
        strIAPListURL = "http://bank.pinoygame.net/api/iapitems?aid=1003";
    }
    if (GlobalVariable::m_iCurrentGame == 2)
    {
        GlobalVariable::m_sAppIDPurchase="1000";
        strIAPListURL = "http://bank.pinoygame.net/api/iapitems?aid=1000";
    }
