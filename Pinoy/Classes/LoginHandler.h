...
extern "C"
{
    extern void Java_com_Pinoy_CapsaSusun_AppActivity_onNativeLoginSucceed(JNIEnv *env, jobject obj, jstring token);
    extern void Java_com_Pinoy_CapsaSusun_AppActivity_onNativeLoginFailed(JNIEnv *env, jobject obj, jstring msrError);
    extern void Java_com_Pinoy_CapsaSusun_AppActivity_onNativeCheckSFSConnected(JNIEnv *env, jobject obj);
    extern void Java_com_Pinoy_CapsaSusun_AppActivity_onNativeSetDeviceID(JNIEnv *env, jobject obj, jstring deviceID);
    extern void Java_com_Pinoy_CapsaSusun_AppActivity_onNativeSetFacebookID(JNIEnv *env, jobject obj, jstring facebookID);
}
