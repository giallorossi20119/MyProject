...
void LoginScene::onEnter()
{
    ...
    imgLoginPanelBg->cocos2d::Node::setScale(0.8f);
    auto moveright  = MoveTo::create(0.3f, Vec2(imgLogo->getPositionX()-190, imgLogo->getPositionY()-50));
    auto movedown = MoveTo::create(0.2f, Vec2(imgLoginPanelBg->getPosition().x + 100, imgLoginPanelBg->getPosition().y - 500));
    auto delay = DelayTime::create(0.3f);
    auto seq1 = Sequence::create(delay, movedown, NULL);
    imgLoginPanelBg->runAction(seq1);
//    imgLogo->setScale(0.8f);
//    imgLogo->runAction(moveright);
    ...
    if(GlobalVariable::m_bDoubleLogin)
    {
        openPopup(new AlertPopup("Someone is trying to login to the game by using your account, please check your password again!"));
        GlobalVariable::m_bDoubleLogin=false;
    }
}
...
void LoginScene::addEventlistener()
{
    ...
    m_btnFacebookLogin->setScale(1.2f);
    m_btnFacebookLogin->setPosition(Vec2(m_btnFacebookLogin->getPositionX()-70, m_btnFacebookLogin->getPositionY()-20));
    ...
    m_btnGoogleLogin->setVisible(false);
    ...
    m_btnAccountBaseLogin->setVisible(false);
    ...
    m_btnDeviceIDLogin->setVisible(true);
    m_btnDeviceIDLogin->setScale(1.2f);
    m_btnDeviceIDLogin->setPosition(Vec2(m_btnDeviceIDLogin->getPositionX()-70, m_btnDeviceIDLogin->getPositionY()-60));
...
{
#if CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID
    Application::getInstance()->openURL("https://play.google.com/store/apps/details?id=com.Pinoy.CapsaSusun");
    exit(0);
#elif CC_TARGET_PLATFORM == CC_PLATFORM_IOS
