...
string MsgConst::getMsg(const char* key, std::vector<string>*  params)
{
	...
	switch (ikey)
	{
        ...
        case OUT_OF_MONEY_ID:
        {
            GlobalVariable::m_bOutofMoney=true;
            str = getCurMsg(OUT_OF_MONEY);
            break;
        }
...
//        }
        ...
        {
            str = getCurMsg(MSG_NOT_ENOUGH_MONEY);
            break;
        }
        case NOT_IN_ROOM:
        {
        ...
        case MSG_WAIT60_BY_KICK_ID:
        {
//            if (GlobalVariable::m_bWasBonusStarup==true)
//            {
...
//            else
//            {
                str = getCurMsg(MSG_WAIT60_BY_KICK);
//            }
            break;
        }
        case 201:
