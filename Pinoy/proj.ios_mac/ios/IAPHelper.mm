...
#define kGameloePaymentURL       @"http://bank.pinoygame.net/api/iap"
...
void sendPayment(NSData *receipt)
{
    ...
    NSString* appidpurchase = [NSString stringWithFormat:@"%s", GlobalVariable::m_sAppIDPurchase.c_str()];
    ...
    [requestValidateReceipt setPostValue:appidpurchase forKey:@"app_id"];
